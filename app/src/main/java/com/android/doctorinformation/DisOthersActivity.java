...
public class DisOthersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewOthers = findViewById(R.id.listViewNeck);
...
// Instantiate the RequestQueue.
        ...
        String url = "https://doctor.rejoanbd.com/others.json";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DisOthersActivity.this);
