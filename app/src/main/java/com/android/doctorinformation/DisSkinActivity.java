...
public class DisSkinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewSkin = findViewById(R.id.listViewNeck);
...
// Instantiate the RequestQueue.
        ...
        String url = "https://doctor.rejoanbd.com/skin.json";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DisSkinActivity.this);
