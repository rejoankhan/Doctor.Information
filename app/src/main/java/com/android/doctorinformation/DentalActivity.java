...
public class DentalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dis_dental);
        listViewDental = findViewById(R.id.listViewDental);
...
// Instantiate the RequestQueue.
        ...
        String url = "https://doctor.rejoanbd.com/dental.json";
        ...
        JsonArrayRequest arrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray jsonArray) {
                ...
                try {
                    ...
                    listViewDental.setAdapter(myAdapter);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DentalActivity.this);
