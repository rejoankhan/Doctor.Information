...
public class DisBrainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewGynee = findViewById(R.id.listViewBrain);

// ...

// Instantiate the RequestQueue.
        RequestQueue queue = Volley.newRequestQueue(this);
        String url = "https://doctor.rejoanbd.com/brain.json";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DisBrainActivity.this);
