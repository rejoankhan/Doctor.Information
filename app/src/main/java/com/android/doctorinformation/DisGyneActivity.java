...
public class DisGyneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dis_gyne);
...
// Instantiate the RequestQueue.
        ...
        String url = "https://doctor.rejoanbd.com/gyne.json";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DisGyneActivity.this);
